          ...
          <div className="basis-1/2">
            <div className={styles.contentBox}>
              <div className={styles.sectionTitle}>
                <p className={styles.titleHint}>Welcome to Agency</p>
              ...
              <div className={clsx(styles.innerBox, "flex")}>
                ...
                <div className={styles.singleItem}>
                  <h5 className={styles.itemTitle}>
                    <span className={styles.titleIndex}>02</span>
                    Sourcing the Best
                  </h5>
                  <p>Lorem ipsum dolor sited is amet consectetur notted.</p>
                </div>
              ...
              <div className="flex justify-around">
                <div
                  className={clsx(styles.authorBox, "flex items-center gap-4")}
                >
                  ...
                  <div>
                    ...
                    <span className={styles.designation}>CEO & CO Founder</span>
                  </div>
                </div>
                <div className={styles.experienceBox}>
                  <div className={styles.inner}>
                    <h2 className={styles.years}>38</h2>
                    <p className={styles.yearText}>Years of Experience</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center justify-center gap-7 lg:flex-row">
          <div className={clsx("basis-1/3", styles.card)}>
            <figure className={styles.imageBox}>
              ...
              <i
                className={clsx("flaticon-consulting", styles.cateogryIcon)}
              ></i>
            </figure>
          ...
          <div className={clsx("basis-1/3", styles.card)}>
            <figure className={styles.imageBox}>
              ...
              <i
                className={clsx("flaticon-controller", styles.cateogryIcon)}
              ></i>
            </figure>
            <div className={styles.lowerContent}>
              <h3 className={styles.h3}>
          ...
          <div className={clsx("basis-1/3", styles.card)}>
            <figure className={styles.imageBox}>
              ...
              <i className={clsx("flaticon-policy", styles.cateogryIcon)}></i>
            </figure>
            <div className={styles.lowerContent}>
              <h3 className={styles.h3}>
...
function SectionWorkingProcess() {
  return (
    <section className={styles.workingProcessSection}>
      <div className={styles.autoContainer}>
        <div className={styles.titleWrapper}>
          <p className={styles.titleHint}>Staffing Recent Closed Projects</p>
