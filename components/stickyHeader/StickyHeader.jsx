      ...
      <div className={clsx(styles.outerBox)}>
        ...
        <div className="">
          <ul className="flex gap-2 text-white">
            ...
            <li
              className={clsx(styles.listItem, styles.dropdownBtn, {
                [`${styles.active}`]: router.pathname === "/service",
              })}
            >
              <Link href="/service">
              ...
              <ul className={styles.dropdown}>
                <li className={styles.dropdownItem}>
                  <Link href="/service">
                    <a className={styles.dropdownAnchor}>Our Solutions</a>
                  </Link>
                </li>
                <li className={styles.dropdownItem}>
                  <Link href="/hr-consulting">
                    <a className={styles.dropdownAnchor}>HR Consulting</a>
                  </Link>
                </li>
              </ul>
            </li>
        ...
        <div>
          <Link href="/contact">
            <a>
              <PrimaryBtn hoverBgColor="white">BOOK APPOINTMENT</PrimaryBtn>
            </a>
          </Link>
        </div>
      </div>
